  ...
  <body>
              ...
              <table class="table table-striped table-bordered" id="locationsTable" style="font-family: 'DM Sans', sans-serif; font-size: 13px;">
                ...
                <tbody>
                    <?php
                        ...
                        $query = "SELECT id, nombre, rating,ST_X(geom) as lng, ST_Y(geom) as lat FROM talleres WHERE categoria LIKE 'Montallantas'";
    ...
    <div class="app-container">
      <div class="left-area" style="z-index: 999">
        ...
        <!-- Enlace a manual -->
        <a class="item-link" id="pageLink2">
        ...
        <a class="item-link" id="pageLink4">
          <img src="img/tire.svg" style="height: 2rem" title="Montallantas" >
        </a>
        <!-- SALIR -->
      ...
      <div class="main-area" style="padding-bottom: 5px;">
        ...
        <section class="content-section" style="margin-top: 0px; padding: 10px;">
          <div class="section-header-wrapper">
            <h1 class="section-header" style="font-size: 15px; text-align: center; margin-bottom: 5px; margin-top: 5px;">Montallantas</h1>
          </div>
          <div class="files-table" style="padding: 5px">
           ...
           //////////////////////////////////////////// mapa///////////////////////////////////////
              ...
              var mllantas = L.geoJSON();
                  $.post("php/cargarmllantas.php",
                      {
                          peticion: 'cargar',
                      ...
                      {
                        mllantas = eval('('+data+')');
                          var mllantas = L.geoJSON(mllantas, {
                      onEachFeature: info_popup
                          });
                          
                          mllantas.eachLayer(function (layer) {
                          layer.setZIndexOffset(1000);
                          });
                  // Agregar capa al controlador de capas
                  leyenda.addOverlay(mllantas, 'Montallantas');
                      }
                  });
        ...
        function fetchDataFromDatabase(location, bufferRadius) {
            ...
            request.open('GET', 'php/buffer_mllantas.php?latitude=' + location.lat + '&longitude=' + location.lng + '&bufferRadius=' + bufferRadius, true);
