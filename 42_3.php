...
<body>
    ...
    <script>
        ...
        // Obtener la ubicación actual del usuario y datos de la base de datos al presionar el botón
        document.getElementById('getDataButton').addEventListener('click', function() {
            navigator.geolocation.getCurrentPosition(function(position) {
                ...
                fetchDataFromDatabase(location, bufferRadius, buffer);
            }, function(error) {
        ...
        function fetchDataFromDatabase(location, bufferRadius, buffer) {
